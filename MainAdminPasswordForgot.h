...
namespace BankMsVersionOne {
	...
	/// <summary>
	/// Summary for MainAdminPasswordForgot
	/// </summary>
	public ref class MainAdminPasswordForgot : public System::Windows::Forms::Form
	{
	public:
		String^ sword;
		String^ sdate;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MainAdminPasswordForgot::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &MainAdminPasswordForgot::button2_Click);
			// 
			// textConfirmPass
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &MainAdminPasswordForgot::button1_Click);
			// 
			// label5
			// 
			...
			this->panel1->Location = System::Drawing::Point(387, 126);
			...
			this->button3->Click += gcnew System::EventHandler(this, &MainAdminPasswordForgot::button3_Click);
			// 
			// label1
			// 
			...
			this->label3->Location = System::Drawing::Point(575, 40);
			...
			this->Name = L"MainAdminPasswordForgot";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"MainAdminPasswordForgot";
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (textUsename->Text->Length != 0)
		{
			...
			try {
				...
				MySqlCommand^ cmd = gcnew MySqlCommand("select username,status,sword,sdate,id from admin", con);
				MySqlDataReader^ dr;
				con->Open();
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (textNewPass->Text == textConfirmPass->Text)
	{
		...
		try {
			String^ constr = "Server=127.0.0.1;Uid=root;Pwd=root;Database=bms";
			MySqlConnection^ con = gcnew MySqlConnection(constr);
			MySqlCommand^ cmd = gcnew MySqlCommand("update admin set password='" + textNewPass->Text + "' WHERE id=" + empId, con);
			con->Open();
